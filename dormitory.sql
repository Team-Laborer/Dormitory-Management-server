...
INSERT INTO `admins` VALUES ('2023-01-12 14:45:18', '2023-01-12 14:45:18', 6, 12);
INSERT INTO `admins` VALUES ('2023-01-12 14:45:27', '2023-01-12 14:45:27', 7, 2);
...
INSERT INTO `backrecords` VALUES (20, '2023-01-12 14:48:04', '2023-01-12 14:48:04', NULL, 14, 5);
...
-- ----------------------------
INSERT INTO `buildings` VALUES (1, '通天苑', '2020-02-15 14:34:55', '2020-02-15 14:34:55', '2023-01-12 14:44:34');
INSERT INTO `buildings` VALUES (2, '大西门', '2020-02-15 14:34:55', '2020-02-15 14:34:55', '2023-01-12 14:44:39');
INSERT INTO `buildings` VALUES (3, '于心苑', '2020-02-21 11:36:05', '2020-02-21 11:36:07', '2023-01-12 14:44:37');
...
INSERT INTO `cleanrecords` VALUES (11, '2023-01-12 14:48:10', '2023-01-12 14:48:10', NULL, 14, 5);
...
CREATE TABLE `evaluates`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `score` int(0) NOT NULL COMMENT '评价分数',
...
CREATE TABLE `floors`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `layer` int(0) NULL DEFAULT NULL COMMENT '楼层',
  `buildingId` int(0) NULL DEFAULT NULL,
  `createdAt` datetime(0) NOT NULL,
  `updatedAt` datetime(0) NOT NULL,
  `deletedAt` datetime(0) NULL DEFAULT NULL,
  `cleanerId` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `rooms`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `number` int(0) NULL DEFAULT NULL COMMENT '房间号',
  `buildingId` int(0) NULL DEFAULT NULL,
  `status` int(0) NOT NULL DEFAULT 1 COMMENT '宿舍状态，可入住为1，不可入住为2',
  `peopleNum` int(0) NOT NULL COMMENT '房间最大人数',
  `createdAt` datetime(0) NOT NULL,
  `updatedAt` datetime(0) NOT NULL,
  `deletedAt` datetime(0) NULL DEFAULT NULL,
...
INSERT INTO `tokens` VALUES (42, '2023-01-12 08:09:37', '2023-01-12 08:09:37', 1);
INSERT INTO `tokens` VALUES (43, '2023-01-12 08:09:56', '2023-01-12 08:09:56', 1);
INSERT INTO `tokens` VALUES (45, '2023-01-12 09:58:33', '2023-01-12 09:58:33', 3);
INSERT INTO `tokens` VALUES (46, '2023-01-12 14:47:39', '2023-01-12 14:47:39', 14);
INSERT INTO `tokens` VALUES (47, '2023-01-12 14:48:38', '2023-01-12 14:48:38', 3);
INSERT INTO `tokens` VALUES (48, '2023-01-12 14:49:14', '2023-01-12 14:49:14', 14);
INSERT INTO `tokens` VALUES (76, '2023-01-13 05:33:57', '2023-01-13 05:33:57', 2);
INSERT INTO `tokens` VALUES (77, '2023-01-13 06:01:17', '2023-01-13 06:01:17', 2);
INSERT INTO `tokens` VALUES (78, '2023-01-13 06:07:49', '2023-01-13 06:07:49', 2);
...
CREATE TABLE `users`  (
  ...
  `type` int(0) NOT NULL COMMENT '用户类型',
  `role` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'student',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `checkTime` datetime(0) NULL DEFAULT NULL COMMENT '入住宿舍时间',
  `createdAt` datetime(0) NOT NULL,
  `updatedAt` datetime(0) NOT NULL,
  `deletedAt` datetime(0) NULL DEFAULT NULL,
  `roomId` int(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`, `account`, `type`) USING BTREE,
  INDEX `roomId`(`roomId`) USING BTREE,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, '123456', '$2a$10$vGnvYKcAYAOLwLF7blj2JeyORsf/BDb/5qVsIoC6ohuD0.4zln7P6', 3, 'student', '王麻', '12222222222', '2020-02-15 14:57:14', '2020-02-15 14:34:55', '2023-01-12 14:44:34', NULL, NULL);
INSERT INTO `users` VALUES (2, 'admin', '$2a$10$j1p65vgqGgUkqFGSNgDJt.SimiTlQDwCQw4.RkAXwcWQzRUnjsN3.', 2, 'admin', '测试一号', '1233333', NULL, '2020-02-15 14:34:55', '2023-01-12 09:56:52', NULL, NULL);
INSERT INTO `users` VALUES (3, 'superAdmin', '$2a$10$UzYrrpiCanig0CFGdqONRe.c65B9d9sEOiD1wH6B/oZCXubJKLi6m', 1, 'superAdmin', '李达康', '122222222', NULL, '2020-02-15 14:34:55', '2020-02-24 14:24:53', NULL, NULL);
INSERT INTO `users` VALUES (4, '111111', '$2a$10$Zm41SRjOlSYl2ph3.YwL/.X340x5PBdr46MOOeKDJjblHBbAYqEl2', 3, 'student', '哇水水', '123456789011', '2020-02-15 14:34:55', '2020-02-15 14:34:55', '2023-01-12 14:44:34', NULL, NULL);
INSERT INTO `users` VALUES (5, '222222', '$2a$10$JAeYA769PDtIL6oqHvv7TOTaFOJZGK7iOwXsxJiMxcZb/VYNXbtrK', 3, 'student', '王大拿', '123456789011', '2020-02-15 14:34:55', '2020-02-15 14:34:55', '2023-01-12 14:44:34', NULL, NULL);
INSERT INTO `users` VALUES (6, '333333', '$2a$10$IvA0ATl.h2NwRS4XFrcsxuF2eEagmwRGGieAYiAdCTA5tEz714H9W', 3, 'student', '王彪s', '1222322333', '2020-02-21 04:49:51', '2020-02-20 07:03:17', '2023-01-12 14:44:37', NULL, NULL);
INSERT INTO `users` VALUES (7, '666666', '$2a$10$h8yVZoEnfOy/DnBnOq4aEOgoS1Zm81b722bV7Na.u0.xBxgzhpURC', 3, 'student', '测试员', '1233333333333', '2020-02-21 15:12:16', '2020-02-21 15:11:55', '2023-01-12 14:44:37', NULL, NULL);
INSERT INTO `users` VALUES (11, '10101010', '$2a$10$urcAJNlkFOpwlJIhPV1l/egzU0uH8eGs8AxgjR5f9JAE6hR7xj7rW', 3, 'student', '测试', '123456', '2020-02-24 14:07:27', '2020-02-24 14:05:57', '2023-01-12 14:44:34', NULL, NULL);
INSERT INTO `users` VALUES (12, 'admin2', '$2a$10$T0477k8Pokm9PbkFpDp6Yerh.ej3I8TTrJa3qxAPRYHWpmJfKQFu2', 2, 'admin', 'admin2', '123', NULL, '2020-02-24 14:21:48', '2020-02-24 14:21:48', NULL, NULL);
INSERT INTO `users` VALUES (13, '1001', '$2a$10$ijVixUPY8YMa18GKyXAIU.9XrzkXl7QNB7fGmHatwjqQ/AMKz2o26', 1, 'superAdmin', 'testt', '100000000', NULL, '2023-01-12 09:59:02', '2023-01-12 09:59:02', NULL, NULL);
INSERT INTO `users` VALUES (14, 'student1', '$2a$10$U8TUdHzCiGOAvA40qnEIw.7cCx90hJhVmN8hhqznDUX3lsROL69LK', 3, 'student', '测试学生', '10000000000', '2023-01-12 14:47:59', '2023-01-12 14:47:37', '2023-01-12 14:47:59', NULL, 5);
